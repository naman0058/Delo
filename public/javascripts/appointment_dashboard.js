...
console.log("result re",result);
    ...
    $('#plandline_number').val(result.landline_number)
    $('#psubcategoryid').val(result.subcategoryid)
    $('#psubservicesid').val(result.subcategoryid)
    $('#pnumber').val(result.number);
    $('#pcityid').val(result.cityid);
    $('#plocalityid').val(result.localityid);
    $('#paddress1').val(result.address1);
...
$('#update').click(function () {  //data insert in database
    let updateobj = {
        ...
        landline_number : $('#plandline_number').val(),
        subservicesid : $('#psubservicesid').val(),
        name: $('#pname').val(),
        number:$('#pnumber').val(),
        localityid : $('#plocalityid').val(),
        cityid : $('#pcityid').val(),
        monday : $('#pmonday').val(),
    ...
    $.post(`/free-listing/update`, updateobj, function (data) {
