...
$.getJSON(`/mart_category/all`, data => {
    categories = data
    makeTable(data)
...
$('#result').on('click', '.deleted', function() {
    const id = $(this).attr('id')
     $.get(`/mart_category/delete`,  { id }, data => {
        refresh()
    })
})
...
$('#update').click(function(){  //data insert in database
    ...
    $.post(`/mart_category/update`, updateobj , function(data) {
       update()
    })
})
...
function refresh() 
{
    $.getJSON(`/mart_category/all`, data => makeTable(data))
}
function update()
{
    $('#result').show()
