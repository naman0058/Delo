...
$('#submit').click(function(){
    ...
    $.post('/mart_subcategory/insert',insertobj,data=>{
...
$('#show').click(function(){
$.getJSON(`/mart_subcategory/all`, data => {
    subcategories = data
    makeTable(data)
...
$('#result').on('click', '.deleted', function() {
    ...
    $.get(`/mart_subcategory/delete`,  { id }, data => {
        refresh()
    })
})
...
$('#update').click(function(){  //data insert in database
    ...
    $.post(`/mart_subcategory/update`, updateobj , function(data) {
       update()
    })
})
...
function refresh() 
{
    $.getJSON(`/mart_subcategory/all`, data => makeTable(data))
}
function update()
{
    $('#result').show()
